...
var img = <HTMLImageElement>document.getElementById("myImage");
console.log(img);
...
function check(e){
  e.preventDefault();
  var inputField = <HTMLInputElement>document.getElementById("guess");
  ...
  if(livesleft == 5){
    var left = <HTMLSpanElement>document.getElementById("live");
    left.innerHTML = "5";
    //img.src = "http://i382.photobucket.com/albums/oo268/Espeon200/hangman/stage2.png";
    img.
